  ...
  return (
    <WidthWrapper className={s.wrapper}>
      ...
      <div className={s.container}>
        <PageTitle
          title={t('cash.withdrawWith')}
          subtitle={t('cash.withdrawWithSubtitle')}
          as='h2'
        />
      </div>
      <Divider noMargin />
      <div className={s.container}>
        <PageTitle
          title={t('cash.depositWith')}
          subtitle={t('cash.depositWithSubtitle')}
          as='h2'
        />
      </div>
      <Divider noMargin />
      <div className={s.container}>
        <PageTitle
          title={t('cash.paymentHistory')}
          subtitle={t('cash.paymentHistorySubtitle')}
          as='h2'
        />
        <div className={s.tableWrapper}>
          <Table variant='dark' striped hoverable>
            <Table.Header>
              ...
              {paymentHistory.map((payment) => (
                <Table.Row key={payment.id}>
                  ...
                  <Table.Cell
                    align='center'
                    className={
                      payment.status === 'Completed' ? s.completed : s.pending
                    }
                  >
                    {payment.status}
                  </Table.Cell>
